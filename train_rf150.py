...
params_save_path = "params/SCFNet-RF150.pth"
...
train_dataset = OpenGF150("./data/OpenGF_Exp", dir="train", pts_num=20000)
# train_loader, _ = get_dataloader(train_dataset, batch_size, num_workers=2, shuffle=True, neighborhood_limits=None)
train_loader, _ = get_dataloader(train_dataset, batch_size, num_workers=4, shuffle=True, neighborhood_limits=train_dataset.config.neighborhood_limits)
val_dataset = OpenGF150("./data/OpenGF_Exp", dir="val", pts_num=20000)
val_loader, _ = get_dataloader(val_dataset, batch_size, num_workers=4, shuffle=False, neighborhood_limits=val_dataset.config.neighborhood_limits)
